      ...
      <div>
        ...
        {!upload && submit ? (
          <>
            ...
            <p style={{ width: '50%', textAlign: 'center', marginLeft: '25%' }}>
              {displayText}
            </p>
          </>
        ) : (
